...
class LanguageModelEN(LanguageModelABC):
    ...
    def set_language_model(self):
        ...
        self.NEW_SETUP = 'Welcome to Telegram Connect. Telegram Connect couples Alexa with your Telegram ' \
                         'Messenger. Now, are you ready to start the setup?'
        ...
        self.RATE_SKILL = "If you enjoy playing {}, share your thoughts by writing a review. We value your " \
        ...
        # SetupIntent
        ##############################
        self.NO_PERMISSION = 'You have not granted permission to Telegram Connect to access your mobile phone number. ' \
                             'In order to connect your Telegram Messenger to Alexa, access is required. Open the Alexa ' \
                             'App and grant the necessary permissions. Bye for now.'

        self.NO_PHONE_NUMBER = 'There was a problem retrieving your phone number. Try again later. If it still does ' \
                               'not work re-enable the skill and check that you entered your phone number in your ' \
                               'Amazon profile. Bye for now. '
        ...
        self.PHONE_CODE_INVALID = '{} is the wrong code. Please try it again now'
